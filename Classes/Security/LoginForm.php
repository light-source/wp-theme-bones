...
abstract class LoginForm
{
    ...
    final private static function captchaVerify(string $token): bool
    {
        $captchaPrivateKey = SiteSettings::get(SiteSettings::GOOGLE_CAPTCHA__PRIVATE_KEY, 'options');
    ...
    final public static function onResources(): void
    {
        ...
        $captchaPublicKey = SiteSettings::get(SiteSettings::GOOGLE_CAPTCHA__PUBLIC_KEY, 'options');
